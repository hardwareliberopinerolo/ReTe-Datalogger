...
#include <secTimer.h> //https://www.leonardomiliani.com/?p=478#wpfb-file-27
#include <Wire.h>
#include <SoftwareSerial.h>
#include <Adafruit_FONA.h> //Modificare nella libreria l’APN inserendo quello corretto in base al gestore della SIM
//ATTENZIONE Modificare nella libreria Adafruit_FONA.cpp l'apn (riga : apn = F("TM") )inserendo il giusto corrispondende in base al gestore della SIM => Non serve più, si imposta da codice
...
DeviceAddress Thermometer3   =       { 0x28, 0xAA, 0x14, 0x44, 0x1A, 0x13, 0x02, 0x25 };
/*
 28 AA CD DB 19 13 02 17 
 28 AA 23 4D 1A 13 02 63 
 28 AA 14 44 1A 13 02 25
...
float temperatura3 = 0;        //variabile backup temperatura  2 per invio al sito
...
char url_string[] = "http://api.thingspeak.com/update?api_key=4U0UPWF5MKAXSKGN&field3"; //URL del sito - non usare https ma http!!!
