...
*/
      //Temperatura3
      dtostrf(temperatura3, 0, 1, atm_time_string6); 
      Serial.print(F("atm_time_string3 : "));
      Serial.println(atm_time_string5);
...
*/      
      //ACS712 Corrente DC
      dtostrf(Ampere, 0, 1, atm_time_string8);
      Serial.print(F("atm_time_string8 : "));
      Serial.println(atm_time_string8);
      

      sprintf(http_cmd, "%s=%s&field4=%s&field5=%s&field8=%s", url_string, atm_time_string3, atm_time_string5,atm_time_string6,atm_time_string8); //Comando per concatenare in una stringa (http_cmd) più stringhe che prendono il posto dei %s
